...
public class UserRepository {
    ...
    public Mono<UserEntity> findAndRemoveById(String id) {
        return reactiveMongoTemplate.findAndRemove(new Query().addCriteria(Criteria.where("id").is(id)), UserEntity.class);
    }
}
